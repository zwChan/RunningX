...
public class RunningXActivity extends Activity {
    ...
    private class HttpGetTask extends
            AsyncTask<String, Void, List<GpsRec>> {

        AndroidHttpClient mClient = AndroidHttpClient.newInstance("");

        @Override
        protected List<GpsRec> doInBackground(String... params) {
        ...
        @Override
        protected void onPostExecute(List<GpsRec> result) {
